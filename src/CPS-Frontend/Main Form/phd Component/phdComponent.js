...
const PhdComponent = () => {
  ...
  const [numberOfStudentCompletedPhd, setnumberOfStudentCompletedPhd] =
    useState(0);
  const [numberOfStudentsPursuingPhd, setnumberOfStudentsPursuingPhd] =
    useState();
  ...
  const handleSelectedOptionForphdGuidePursuingStundet = (index, option) => {
    ...
    newPhdList[index] = {
      ...newPhdList[index],
      phdPrincipalGuidePursuingStudent: option,
    };
    ...
    if (numberOfStudentCompletedPhd) {
      ...
      setphdList((prevList) => {
        ...
        if (newList.length < count) {
          newList.push(
            ...Array(count - newList.length).fill({ phdPrincipalGuide: "" })
          );
        } else {
        ...
        if (newList.length < count) {
          newList.push(
            ...Array(count - newList.length).fill({
              phdPrincipalGuidePursuingStudent: "",
            })
          );
        } else {
          newList.length = count;
      ...
      >
        ...
        <FormGroup sx={{ marginTop: "10px", marginBottom: "20px" }}>
          <FormControlLabel
            control={
              <Checkbox
                checked={phdOptionChecked}
                onChange={(e) => handlePhdOptionChecked(e)}
              />
            }
            label="Are any students under your supervision currently pursuing or have they completed a Ph.D.?"
          />
        </FormGroup>
        ...
        {phdOptionChecked && (
          <>
            <CardContent>
              <TextField
                type="number"
                label="How many students have been Awarded Ph.D."
                fullWidth
                onChange={(e) => setnumberOfStudentCompletedPhd(e.target.value)}
              />
              ...
              {phdList.map((_, index) => (
                <>
                  <FormGroup sx={{ marginTop: "40px" }}>
                    ...
                    >
                      Information About Ph.D. Completed Student {index + 1}
                    </Typography>
                    <Typography>
                      Were you the only Principal Guide / Main Guide?{" "}
                      <span style={{ color: "red" }}>*</span>
                    </Typography>
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={_.phdPrincipalGuide === "Yes"}
                          onChange={() =>
                            handleSelectedOptionForphdGuideCompletedStudent(
                              index,
                              "Yes"
                            )
                          }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={_.phdPrincipalGuide === "No"}
                          onChange={() =>
                            handleSelectedOptionForphdGuideCompletedStudent(
                              index,
                              "No"
                  ...
                  {_.phdPrincipalGuide === "No" && (
                    <FormGroup sx={{ marginTop: "10px" }}>
                      <TextField
                        type="number"
                        label="How many supervisors / guides were there"
                      />
                    </FormGroup>
                  )}
            ...
            <CardContent>
              <TextField
                type="number"
                label="How many Students are Pursuing Ph.D."
                fullWidth
                onChange={(e) => setnumberOfStudentsPursuingPhd(e.target.value)}
              />
                ...
                <>
                  <FormGroup sx={{ marginTop: "40px" }}>
                    <Typography
                      ...
                      sx={{ marginBottom: "20px", textAlign: "center" }}
                    >
                      Information About Ph.D. Pursuing Student {index + 1}
                    </Typography>
                    <Typography>
                      Were you the only Principal Guide / Main Guide?{" "}
                      <span style={{ color: "red" }}>*</span>
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={_.phdPrincipalGuidePursuingStudent === "Yes"}
                          onChange={() =>
                            handleSelectedOptionForphdGuidePursuingStundet(
                              index,
                              "Yes"
                            )
                          }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={_.phdPrincipalGuidePursuingStudent === "No"}
                          onChange={() =>
                            handleSelectedOptionForphdGuidePursuingStundet(
                              index,
                              "No"
