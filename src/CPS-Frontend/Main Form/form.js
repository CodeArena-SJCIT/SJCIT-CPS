  ...
  return (
    <>
      <div className="main-form-div">
        ...
        >
          <CardHeader
            title="Externally Funded Projects and Patents"
          ...
          <CardContent>
            ...
            >
              <Typography>
                Have you done Any Externally Sponsored R&D Projects
              </Typography>
              <RadioGroup
                row
                sx={{ gap: 2 }}
            ...
            <CardContent>
              <TextField
                ...
                onChange={(e) => {
                  ...
                  setnumberOfResearchProjects(e.target.value);
                }}
              />
            </CardContent>
          )}
          ...
          <CardContent>
            ...
            >
              <Typography>
                Have you published any patents or hold ownership of any patents?
              </Typography>
              <RadioGroup
                row
                sx={{ gap: 2 }}
                value={patentChecked}
                onChange={(e) => setPatentChecked(e.target.value)}
              >
                <FormControlLabel value="Yes" control={<Radio />} label="Yes" />
                <FormControlLabel value="No" control={<Radio />} label="No" />
              </RadioGroup>
          ...
          {patentChecked !== "No" && patentChecked && (
            <CardContent>
              <TextField
        ...
        >
          ...
          >
            ...
            <RadioGroup
              row
              sx={{ gap: 2 }}
              value={consultancyProjectsOption}
            ...
            <CardContent>
              <TextField
                ...
                onChange={(e) => {
                  ...
                  e.target.value = value;
                  setconsultancyProjectAmount(e.target.value);
                }}
              />
            </CardContent>
          )}
