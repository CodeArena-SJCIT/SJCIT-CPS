  ...
  return (
    <>
      ...
      >
        ...
        >
          <Typography>
            Do you have any Conference papers indexed in SCI / Scopus / Web of
            Science Conference / any internationally renowned conference?
          </Typography>
          <RadioGroup
            row
            sx={{ gap: 2 }}
            value={conferencePaperChecked}
            ...
            <CardContent>
              <TextField
                ...
                onChange={(e) => {
                  ...
                  setnumberOfConferencePapers(e.target.value);
                }}
              />
            </CardContent>
